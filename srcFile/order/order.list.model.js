(function ($, window) {
	...
	OrderQueryResultModel.proto({
		...
		load : function (params, cbFn) {
			...
			IX.Debug.info('DEBUG: Order List Model AJAX Params: ');
			IX.Debug.info(self.getPagerParams());
		...
		sumRecordSort : function (params) {
			...
			var post = $XP(params, 'params', {}),
				cbFn = $XF(params, 'cbFn');
				self.updatePagerParams(post);
			var postParams = IX.inherit(self.getPagerParams(),post);
			Hualala.Global.sumRecordSort(post, function (res) {
				if (res.resultcode == '000') {
					self.updateDataStore($XP(res, 'data.records', []), $XP(res, 'data.page.pageNo'));
					self.updatePagerParams($XP(res, 'data.page', {}));
					self.updateStatisticDataStore($XP(res, 'data', {}));
		...
		foodAmountSort : function (params,cbFn) {
			var self = this;
			var post = $XP(params, 'params', {}),
				cbFn = $XF(params, 'cbFn');
				self.updatePagerParams(post);
			var postParams = IX.inherit(self.getPagerParams(),post);
			Hualala.Global.foodAmountSort(postParams, function (res) {
				if (res.resultcode == '000') {
					self.updateDataStore($XP(res, 'data.records', []), $XP(res, 'data.page.pageNo'));
					self.updatePagerParams($XP(res, 'data.page', {}));
					self.updateStatisticDataStore($XP(res, 'data', {}));
		...
		unitPriceSort : function (params,cbFn) {
			var self = this;
			var post = $XP(params, 'params', {}),
				cbFn = $XF(params, 'cbFn');
				self.updatePagerParams(post);
			var postParams = IX.inherit(self.getPagerParams(),post);
			Hualala.Global.unitPriceSort(postParams, function (res) {
				if (res.resultcode == '000') {
					self.updateDataStore($XP(res, 'data.records', []), $XP(res, 'data.page.pageNo'));
					self.updatePagerParams($XP(res, 'data.page', {}));
					self.updateStatisticDataStore($XP(res, 'data', {}));
		...
		rewardOrderSort : function (params) {
			...
			var post = $XP(params, 'params', {}),
				...
				self.updatePagerParams(post);
			var postParams = IX.inherit(self.getPagerParams(),post);
			Hualala.Global.rewardOrderSort(post, function (res) {
				if (res.resultcode == '000') {
					self.updateDataStore($XP(res, 'data.records', []), $XP(res, 'data.page.pageNo'));
					self.updatePagerParams($XP(res, 'data.page', {}));
					self.updateStatisticDataStore($XP(res, 'data', {}));
		...
		dishesHotSort : function (params) {
			...
			var post = $XP(params, 'params', {}),
				...
				self.updatePagerParams(post);
			var postParams = IX.inherit(self.getPagerParams(),post);
			Hualala.Global.dishesHotSort(post, function (res) {
				if (res.resultcode == '000') {
					self.updateDataStore($XP(res, 'data.records', []), $XP(res, 'data.page.pageNo'));
					self.updatePagerParams($XP(res, 'data.page', {}));
					self.updateStatisticDataStore($XP(res, 'data', {}));

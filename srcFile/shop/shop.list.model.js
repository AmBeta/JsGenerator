				...
				"setServiceParams" : function (cfg) {
					...
					callServer(IX.inherit(params, {
						...
						if (res.resultcode !== '000') {
							...
							var newData = {};
							newData[serviceID] = (res.records && res.records[0]) || params;
							...
							var revParamJson = self.get('revParamJson') || null,
								...
								rewardDetailJson = self.get('rewardDetailJson') || null;
							...
							if (serviceID == 20 || serviceID == 21) {
								...
								rewardDetailJson = IX.inherit(rewardDetailJson, newData);
								self.set('rewardDetailJson', JSON.stringify(rewardDetailJson));
							} else {
